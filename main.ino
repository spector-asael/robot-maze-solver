...
void readjustRightwardsVeryStrong() {
  ...
  motorL.run(BASESPEED + 40);
  motorR.run(-BASESPEED - 5);
}
...
void loop() {
  ...
  bool rightBlocked = (rightDist > 0 && rightDist < 15);
